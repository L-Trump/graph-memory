...
6. 输出规范：
   6.1 只返回 JSON，格式为 {"nodes":[...],"edges":[...],"beliefUpdates":[...]},禁止 markdown 代码块包裹
   6.2 禁止解释文字，禁止额外字段
   6.3 没有知识产出且无需置信度更新时返回 {"nodes":[],"edges":[]}
   6.4 有置信度更新但无新知识时返回 {"nodes":[],"edges":[],"beliefUpdates":[...]}
   6.5 每条 edge 的 description 必须写具体内容，不能为空或"见上文"
   6.6 beliefUpdates 只针对已有节点，新创建的节点不需要 beliefUpdates
